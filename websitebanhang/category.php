...
$item = mysqli_query($link,"SELECT *,`Ten` FROM `sanpham`, `loaisanpham` WHERE `sanpham`.`MaLSP` = $maLSP AND `sanpham`.`MaLSP` = `loaisanpham`.`MaLSP` " . $where);
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="breadcrumb-tree">
                    ...
                    <li><a href="#"><?php foreach ($cate as $key => $value): ?>
                            <?php echo $value['Ten']?>
                            <?php endforeach; ?>
                        </a></li>
                </ul>
                        ...
                        <div class="col-md-4 col-xs-6">
                            <div class="product">
                                ...
                                <div class="add-to-cart">
                                    <form action="process/cart.php?id=<?php echo $value['maSP'] ?>&price=<?php echo $value['GiaBan'] ?>&TenSP=<?php echo $value['TenSP'] ?>&HinhAnh=<?php echo $value['HinhAnh'] ?>&MaLSP=<?php echo $value['MaLSP'] ?>&option=category" method="post">
